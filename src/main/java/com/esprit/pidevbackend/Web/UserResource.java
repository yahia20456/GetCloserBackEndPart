...
public class UserResource {
    ...
    public ResponseEntity<User> updateUser(@RequestParam("user") String user  , @PathVariable Long id , @RequestParam("f") MultipartFile f) throws MessagingException, IOException {
         userService.updateUser(user,id,f);
         return ResponseEntity.accepted().build();
    }
    @Secured("ROLE_ADMIN")
