...
public class AchievementsImpl implements AchievementsService {
    ...
    public List<Achievements> retrieveAllachievements() {
        List<Achievements> achievements = (List<Achievements>) AchievementRepo.findAll();
        return achievements ;
    }

    @Override
    public Achievements retrieveAchievementsById(Long idAchievements) {
        return AchievementRepo.findById(idAchievements).orElse(null);
    }
    ...
    public void updateAchievements(Long id, Achievements achievements) {
        achievements.setIdAchievements(id);
